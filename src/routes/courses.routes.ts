...
export default (commandsProccessor: CommandsProcessor, updatesProcessor: UpdatesProcessor) => {
  ...
  coursesRoutes
    ...
    .post('/:schoolId/courses/:courseId/enroll/teachers/:userId', (ctx: Koa.Context) => {
      const controller = new CoursesController(new CoursesService(ctx.uow, commandsProccessor, updatesProcessor));
      return controller.enrollTeacher(ctx);
    })
    .post('/:schoolId/courses/:courseId/drop/teachers/:userId', (ctx: Koa.Context) => {
      const controller = new CoursesController(new CoursesService(ctx.uow, commandsProccessor, updatesProcessor));
    ...
    .post('/:schoolId/courses/:courseId/enroll/teachers', (ctx: Koa.Context) => {
      const controller = new CoursesController(new CoursesService(ctx.uow, commandsProccessor, updatesProcessor));
    ...
    .post('/:schoolId/courses/:courseId/drop/teachers', (ctx: Koa.Context) => {
      const controller = new CoursesController(new CoursesService(ctx.uow, commandsProccessor, updatesProcessor));
    ...
    .post('/:schoolId/teachers/enroll/courses', (ctx: Koa.Context) => {
      const controller = new CoursesController(new CoursesService(ctx.uow, commandsProccessor, updatesProcessor));
      return controller.enrollTeachersInCourses(ctx);
    })
    .post('/:schoolId/teachers/drop/courses', (ctx: Koa.Context) => {
      const controller = new CoursesController(new CoursesService(ctx.uow, commandsProccessor, updatesProcessor));
      return controller.dropTeachersInCourses(ctx);
    })
    .post('/:schoolId/teachers/switch/courses', (ctx: Koa.Context) => {
      const controller = new CoursesController(new CoursesService(ctx.uow, commandsProccessor, updatesProcessor));
