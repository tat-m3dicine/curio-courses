...
describe(`Courses Controller`, () => {
  ...
  it(`should succeed in switching students' courses`, async () => {
    ...
    _coursesServiceStub.switchUsers = async () => <any>{ done: true };
    await coursesController.switchStudentsCourses(ctx);
    expect(ctx.status).equal(200);
    _coursesServiceStub.switchUsers = async () => <any>{ done: false };
    await coursesController.switchStudentsCourses(ctx);
    expect(ctx.status).equal(201);
  });
  ...
  it(`should fail to get active courses (Role: undefined)`, async () => {
    _coursesServiceStub.getActiveCourses = async () => <any>undefined;
    await coursesController.getActiveCourses(ctx);
    expect(ctx.body).to.equal(undefined);
  });

  it(`should succeed in getting active courses (Role: student)`, async () => {
  ...
  it(`should succeed in getting active courses (Role: teacher)`, async () => {
  ...
  it(`should succeed in getting active courses (Role: principal)`, async () => {
